...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function() {
    ...
    Route::group(['middleware' =>['auth']], function() {
        ...
        Route::group(['prefix' => 'book-hotel'], function(){
            Route::get('/', 'BookHotelController@index')->name('book.hotel.index');
            Route::get('/update/{status}/{id}', 'BookHotelController@updateStatus')->name('book.hotel.update.status');
            Route::get('/delete/{id}', 'BookHotelController@delete')->name('book.hotel.delete');
        });
...
Route::group(['namespace' => 'Page'], function() {
    ...
    Route::get('/dat-phong/{id}/{slug}.html', 'HotelController@bookHotel')->name('book.hotel');
    Route::post('/book/hotel/{id}', 'HotelController@postBookHotel')->name('post.book.hotel');
